...
<template>
    ...
    <AdminLayout>
        ...
        <div style="background: white; border-radius: 14px; border: 1px solid #eef2f8; box-shadow: 0 2px 8px rgba(0,0,0,.04); overflow: hidden;">
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="border-bottom: 1px solid #f0f4f8;">
                        <th style="text-align: left; padding: 12px 16px; font-size: 10px; font-weight: 800; color: #8ba0b0; text-transform: uppercase; letter-spacing: .07em;">Conteúdo</th>
                        <th style="text-align: left; padding: 12px 16px; font-size: 10px; font-weight: 800; color: #8ba0b0; text-transform: uppercase; letter-spacing: .07em;">Autor</th>
                        <th style="text-align: left; padding: 12px 16px; font-size: 10px; font-weight: 800; color: #8ba0b0; text-transform: uppercase; letter-spacing: .07em;">Data</th>
                        <th style="text-align: left; padding: 12px 16px; font-size: 10px; font-weight: 800; color: #8ba0b0; text-transform: uppercase; letter-spacing: .07em;">Estado</th>
                ...
                <tbody>
                    ...
                    >
                        <td style="padding: 12px 16px; max-width: 340px;">
                            <p :style="{ fontSize: '13px', color: '#2a4a5a', margin: 0, fontStyle: p.deleted ? 'italic' : 'normal' }">{{ p.content }}</p>
                        </td>
                        ...
                        <td style="padding: 12px 16px; font-size: 12px; color: #8ba0b0; white-space: nowrap;">{{ p.created_at }}</td>
                        <td style="padding: 12px 16px;">
                            <span
                                :style="{
                                    fontSize: '10px', fontWeight: '800', padding: '3px 8px', borderRadius: '99px',
                        ...
                        <td style="padding: 12px 16px; text-align: right; white-space: nowrap;">
                            <button
                                v-if="p.deleted"
                                @click="restore(p.id)"
                                style="font-size: 11px; color: #2ea87e; background: none; border: 1px solid #2ea87e33; border-radius: 6px; padding: 4px 10px; cursor: pointer; font-weight: 600; margin-right: 6px; transition: all .2s;"
            ...
            <div v-if="posts.last_page > 1" style="padding: 14px 16px; border-top: 1px solid #f0f4f8; display: flex; gap: 6px; justify-content: center;">
                <Link
