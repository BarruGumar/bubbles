                ...
                >
                    <div style="display: flex; align-items: center; justify-content: space-between">
                        <div>
                            ...
                            <p
                                v-if="totalUnread > 0"
                                style="font-size: 11px; color: #009ac7; margin: 2px 0 0; font-weight: 700"
                            >
                        ...
                        <Link
                            ...
                            @mouseenter="
                                ...
                                $event.currentTarget.style.boxShadow = '0 6px 20px #009ac740';
                            "
                            @mouseleave="
                                $event.currentTarget.style.transform = 'scale(1)';
                                $event.currentTarget.style.boxShadow = '0 3px 12px #009ac730';
                            "
                        >
                            <svg
                                width="15"
                ...
                <div style="flex: 1; overflow-y: auto; padding: 8px">
                    ...
                    <div v-else-if="conversations.length === 0" style="text-align: center; padding: 60px 20px">
                        ...
                        <p style="font-size: 11px; color: #b0c0cc; margin: 6px 0 0">
                            ...
                            <Link
                                :href="route('friends.index')"
                                style="color: #009ac7; text-decoration: none; font-weight: 700"
                                >amigos</Link
                            >
                            e inicia uma conversa.
                        </p>
                    </div>
                    ...
                    <Link
                        ...
                        :style="{
                            ...
                            border:
                                activeConversation?.id === conv.id ? '1px solid #009ac722' : '1px solid transparent',
                        }"
                        @mouseenter="
                            (e) => {
                                if (activeConversation?.id !== conv.id)
                                    e.currentTarget.style.background = 'rgba(0,154,199,0.05)';
                            }
                        "
                        @mouseleave="
                            (e) => {
                    ...
                    >
                        ...
                        <div style="flex: 1; min-width: 0">
                            ...
                            <p
                                ...
                                "
                                :style="{
                                    color: conv.unread_count > 0 ? '#009ac7' : '#8ba0b0',
            ...
            >
                ...
                >
                    <div
                        ...
                        style="max-width: 480px; width: 100%; margin: 0 auto; padding: 40px 28px 60px"
                    >
                        <div style="text-align: center; margin-bottom: 32px">
                            ...
                            <p style="font-size: 16px; font-weight: 800; color: #1a3a4a; margin: 0 0 6px">
                                As tuas mensagens
                            </p>
                            <p style="font-size: 13px; color: #8ba0b0; margin: 0; line-height: 1.5">
                                Escolhe um amigo para começar a conversar.
                            </p>
                        </div>
                        <div
                            style="
                        ...
                        >
                            ...
                            >
                                ...
                                <div style="flex: 1; min-width: 0">
                                    ...
                                    <p v-if="f.username" style="font-size: 12px; color: #009ac7; margin: 2px 0 0">
                                        @{{ f.username }}
                                    </p>
                                </div>
                                <span
                    ...
                    >
                        ...
                        <Link
                            ...
                            @mouseenter="
                                ...
                                $event.currentTarget.style.boxShadow = '0 8px 24px #009ac740';
                            "
                            @mouseleave="
                                $event.currentTarget.style.transform = 'translateY(0)';
                                $event.currentTarget.style.boxShadow = '0 4px 16px #009ac730';
                            "
                            >Ver amigos</Link
                        >
                    </div>
                ...
                <template v-else>
                    ...
                    >
                        ...
                        >
                            {{ avatarInitial(activeConversation.other_user?.name) }}
                        </div>
                        <div style="flex: 1; min-width: 0">
                            <p
                                style="
                            ...
                            <p
                                ...
                                style="font-size: 11px; color: #009ac7; margin: 1px 0 0"
                            >
                        ...
                        <Link
                            ...
                            "
                            @mouseenter="
                                $event.currentTarget.style.background = 'rgba(0,154,199,0.14)';
                                $event.currentTarget.style.borderColor = '#009ac7';
                            "
                            @mouseleave="
                                $event.currentTarget.style.background = 'rgba(0,154,199,0.06)';
                                $event.currentTarget.style.borderColor = '#009ac733';
                            "
                            >Ver perfil</Link
                        >
                    </div>
                            ...
                            >
                                ...
                                >
                                    <button
                                        ...
                                        "
                                        @mouseenter="
                                            $event.currentTarget.style.background = 'rgba(0,154,199,0.12)';
                                    ...
                                    <button
                                        ...
                                        "
                                        @mouseenter="
                                            $event.currentTarget.style.background = 'rgba(224,85,85,0.10)';
                                ...
                                <div
                                    ...
                                    style="
                                        ...
                                        padding: 6px 10px;
                                        backdrop-filter: blur(8px);
                                        box-shadow: 0 2px 10px #e055550a;
                                    "
                                >
                                    <span style="font-size: 11px; color: #5a7a8a; font-weight: 600"
                                        >Eliminar mensagem?</span
                                    >
                                    <button
                                        ...
                                        editingId === item.id
                                            ...
                                            : item.is_own
                                              ? {
                                                    background:
                                                        item.image_url && !item.content
                                                            ? 'transparent'
                                                            : `linear-gradient(135deg, ${authUser?.avatar_color ?? '#009ac7'}, ${authUser?.avatar_color ?? '#009ac7'}cc)`,
                                                    color: 'white',
                                                    borderBottomRightRadius: '5px',
                                                    boxShadow:
                                                        item.image_url && !item.content
                                                            ? 'none'
                                                            : `0 4px 16px ${authUser?.avatar_color ?? '#009ac7'}44`,
                                              ...
                                              : {
                                                    ...
                                                    backdropFilter:
                                                        item.image_url && !item.content ? 'none' : 'blur(12px)',
                                                    color: '#1a3a4a',
                                ...
                                >
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                style="
                                                    ...
                                                    cursor: pointer;
                                                "
                                                :style="{ opacity: !editContent.trim() || actionLoading ? 0.6 : 1 }"
                                            >
                                                Guardar
                                            </button>
                                        </div>
                                    ...
                                    <template v-else>
                                        ...
                                        <span
                                            v-if="item.content"
                                            :style="
                                                item.image_url ? { display: 'block', padding: '8px 14px 10px' } : {}
                                            "
                                            >{{ item.content }}</span
                                        >
                                    </template>
                                ...
                                <span style="font-size: 10px; color: #b0c0cc; margin-top: 3px; padding: 0 3px">
                                    ...
                                    <span v-if="item.is_edited" style="font-style: italic; opacity: 0.7"
                                        >· editado</span
                                    >
                                </span>
                            </div>
                        ...
                        <div v-if="!isNearBottom" style="position: absolute; bottom: 90px; right: 28px; z-index: 10">
                            <button
                                ...
                                style="
                                    ...
                                    font-size: 16px;
                                    cursor: pointer;
                                    box-shadow: 0 4px 16px #009ac740;
                                    display: flex;
                                    align-items: center;
                                    justify-content: center;
                    ...
                    >
                        ...
                        <div style="display: flex; align-items: flex-end; gap: 10px">
                            ...
                            <button
                                ...
                                :style="{
                                    ...
                                    justifyContent: 'center',
                                    cursor: 'pointer',
                                    boxShadow: '0 3px 12px #009ac740',
                                    transition: 'transform .2s, box-shadow .2s, opacity .2s, background .3s',
                                    opacity:
                                        (!msgForm.content.trim() && !msgForm.image) || sendState === 'sending'
                                            ? '0.45'
                                            : '1',
                                }"
                                @mouseenter="
                                    (e) => {
                                        if (sendState === 'idle') {
                                            ...
                                            e.currentTarget.style.boxShadow = '0 6px 20px #009ac750';
                                        }
                                    }
                                "
                                @mouseleave="
                                    (e) => {
                                        ...
                                        e.currentTarget.style.boxShadow = '0 3px 12px #009ac740';
                                    }
                                "
                            >
                                <!-- Sending spinner -->
                        ...
                        <p
                            ...
                            style="font-size: 10px; color: #e05555; margin: 0; text-align: center; font-weight: 600"
                        >
