    ...
    <AuthenticatedLayout>
        <div style="max-width: 680px; margin: 0 auto; padding: 40px 20px 80px;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
                <h1 style="font-size: 22px; font-weight: 900; color: #1a3a4a; margin: 0; letter-spacing: -.02em;">Feed</h1>
            ...
            <div
                ...
                style="text-align: center; padding: 60px 20px; background: rgba(255,255,255,0.88); border-radius: 18px; border: 1px solid #4ebcff1a;"
            >
                ...
                <p style="font-size: 13px; color: #8ba0b0; margin: 0;">Entra em comunidades e adiciona amigos para ver o conteúdo deles aqui.</p>
            </div>

            <!-- Hint when we show recent instead -->
            <div
                v-else-if="!hasFriends && !hasCommunities && feed.length > 0"
                style="background: rgba(0,154,199,0.06); border: 1px solid #009ac722; border-radius: 12px; padding: 12px 16px; margin-bottom: 16px; display: flex; align-items: center; gap: 10px;"
            >
