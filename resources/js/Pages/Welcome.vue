  ...
  >
      ...
      <nav v-if="canLogin" style="display: flex; align-items: center; gap: 4px;">
        ...
        <template v-else>
          ...
          <Link
            ...
            @mouseenter="$event.currentTarget.style.background='#0088a8'; $event.currentTarget.style.boxShadow='0 6px 16px #009ac744'"
            @mouseleave="$event.currentTarget.style.background='#009ac7'; $event.currentTarget.style.boxShadow='0 4px 12px #009ac722'"
          >
            Criar conta
          </Link>
        </template>
    ...
    >
      <div style="text-align: center; max-width: 640px; padding: 0 24px;">
        ...
        <!-- CTA Buttons -->
        <div v-if="canLogin && !authUser" style="display: flex; gap: 12px; justify-content: center; pointer-events: all;">
          <Link
            :href="route('login')"
            :style="{
              padding: '12px 32px',
            ...
            @mouseenter="$event.currentTarget.style.background='#0088a8'; $event.currentTarget.style.boxShadow='0 8px 28px #009ac755'"
            @mouseleave="$event.currentTarget.style.background='#009ac7'; $event.currentTarget.style.boxShadow='0 6px 20px #009ac733'"
          >
            Entrar
          </Link>
          ...
          <Link
            ...
            @mouseenter="$event.currentTarget.style.background='white'; $event.currentTarget.style.boxShadow='0 4px 16px rgba(0,0,0,0.12)'"
            @mouseleave="$event.currentTarget.style.background='rgba(255,255,255,0.85)'; $event.currentTarget.style.boxShadow='0 2px 10px rgba(0,0,0,0.08)'"
          >
            Criar conta
          </Link>
        </div>
